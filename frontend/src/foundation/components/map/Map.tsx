...
import { startboard1Layout, gameboard1Layout, gameboard2Layout, gameboard3Layout } from './mapLayouts';
import type { BoardId, RobotState } from '../../../hooks/game/useRobotMovement';
